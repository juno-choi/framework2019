...
SET DEFINE OFF;
Insert into SCOTT.STRUTS04 (NUM,SUB,NAME,CONTENT,NALJA) values (1,'test1','tester','contentTest',to_date('19/07/18','RR/MM/DD'));
Insert into SCOTT.STRUTS04 (NUM,SUB,NAME,CONTENT,NALJA) values (3,'test3','tester2','contentTest2',to_date('19/07/18','RR/MM/DD'));
Insert into SCOTT.STRUTS04 (NUM,SUB,NAME,CONTENT,NALJA) values (2,'test2','tester2','contentTest2',to_date('19/07/18','RR/MM/DD'));
--------------------------------------------------------
